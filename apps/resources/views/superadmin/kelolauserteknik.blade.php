...
<head>
    <meta charset="utf-8" />
    <title>User Teknik | CRM POP</title>
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-bordered mb-3">
                                        <li class="nav-item">
                                            ...
                                            <a href="/create-userteknik" class="btn btn-primary">+ Create User Teknik</a>
                                        </li>
                                    </ul> <!-- end nav-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            <a href="/edit-userteknik" class="action-icon"> <i class="dripicons-document-edit"></i></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
