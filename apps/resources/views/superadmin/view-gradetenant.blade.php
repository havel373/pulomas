                ...
                <div class="content">
                    ...
                    <!-- end Topbar -->
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Update Grade</h4>

                                        <ul class="nav nav-tabs nav-bordered mb-3">
                                        </ul> <!-- end nav-->
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="tooltips-validation-preview">
                                                <form class="needs-validation" action='/update_gradetenant/{{ $data->id }}' method="POST" enctype="multipart/form-data" novalidate>
                                                    @csrf
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label" for="validationTooltip01">Kode Grade</label>
                                                        <input type="text" name=KodeGrade class="form-control" id="validationTooltip01" placeholder="" value="{{ $data->KodeGrade }}" required>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <input type="number" name=NilaiGrade class="form-control" id="validationTooltip02" placeholder="" value="{{ $data->NilaiGrade }}" required>
                                                        <div class="invalid-tooltip">
                                                            *required
                                                        </div>
                                                    </div>
