...
<head>
    <meta charset="utf-8" />
    <title>Kelola Lantai | CRM POP</title>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Edit Gedung</h4>
                            ...
                            <div class="tab-content">
                                            <div class="tab-pane show active" id="tooltips-validation-preview">
                                                ...
                                                <div>
                                                <label class="form-label" for="validationTooltip01">Pilih Gedung</label>
                                                <select class="form-select mb-3">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label" for="validationTooltip01">Nama Lantai</label>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label">Harga Sewa Ruangan</label>
                                                        <div class="input-group" id="validationTooltip01">
                                                        <input id="timepicker" type="text" class="form-control">
                                                        <span class="input-group-text">m2/Bulan</i></span>
                                                    </div>
                                                    </div>
                                                    <div class="position-relative mb-3">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label">Service Charge Listrik Sendiri</label>
                                                        <div class="input-group" id="input-group1">
                                                        <input id="timepicker" type="text" class="form-control">
                                                        <span class="input-group-text">m2/Bulan</i></span>
                                                    </div>
                                                    ...
                                                    <a href="/kelolalantai" class="btn btn-info">Kembali</a>
