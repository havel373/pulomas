...
<head>
    <meta charset="utf-8" />
    <title>User Keuangan | CRM POP</title>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Create User Keuangan</h4>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="tooltips-validation-preview">
                                    <form class="needs-validation" novalidate>
                                        <div class="mb-3">
                                            <label for="example-select" class="form-label">Status Pegawai</label>
                                            <select class="form-select" id="example-select">
                                                <option>Pilih Satu Pegawai</option>
                                                <option>Pegawai PMJ</option>
                                                <option>Bukan Pegawai PMJ</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="position-relative mb-3">
                                            <label class="form-label" for="validationTooltip03">Nama Pegawai Keuangan</label>
                                            <input type="text" class="form-control" id="validationTooltip03" placeholder="" required>
                                            <div class="invalid-tooltip">
                                                *required </div>
                                        </div>
                                        <div class="position-relative mb-3">
                                            <label class="form-label" for="validationTooltip03">Nomor Handphone</label>
                                            <input type="text" class="form-control" id="validationTooltip03" placeholder="" required>
                                            <div class="invalid-tooltip">
                                                *required </div>
                                        </div>
                                        ...
                                        <a href="/kelolauserkeuangan" class="btn btn-info">Cancel</a>
