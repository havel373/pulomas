                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-bordered mb-3">
                                        <li class="nav-item">
                                            ...
                                            <a href="/create-usermarketing" class="btn btn-primary">+ Create User Marketing</a>
                                        </li>
                                    </ul> <!-- end nav-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            <a href="/edit-usermarketing" class="action-icon"> <i class="dripicons-document-edit"></i></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
