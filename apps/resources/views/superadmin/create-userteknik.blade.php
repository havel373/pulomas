...
<head>
    <meta charset="utf-8" />
    <title>User Marketing | CRM POP</title>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="tooltips-validation-preview">
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="position-relative mb-3">
                                            <label class="form-label" for="validationTooltip03">Nama Pegawai Teknik</label>
                                            <input type="text" class="form-control" id="validationTooltip03" placeholder="" required>
                                            <div class="invalid-tooltip">
                                                *required </div>
                                        </div>
                                        ...
                                        <a href="/kelolauserteknik" class="btn btn-info">Cancel</a>
