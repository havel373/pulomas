...
<head>
        <meta charset="utf-8" />
        <title>Grade Tenant | CRM POP</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Data Grade</h4>
                                </div>
                            </div>
                        </div> <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        <ul class="nav nav-tabs nav-bordered mb-3">
                                            <li class="nav-item">
                                                ...
                                                <a href="/create_gradetenant" class="btn btn-primary">+ Create Grade</a>
                                            </li>
                                                ...
                                                <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            $no = 1;
                                                        @endphp
                                                        @foreach ($data as $gradetenantrow)
                                                        <tr>
                                                            <td>{{ $no++ }}</td>
                                                            <td>{{ $gradetenantrow->KodeGrade }}</td>
                                                            <td>{{ $gradetenantrow->NilaiGrade }}</td>
                                                            <td>
                                                                <a class="btn btn-info" href="/view_gradetenant/{{ $gradetenantrow->id }}">
                                                                    <i class="dripicons-document-edit"></i>
                                                                </a>
                                                                <a class="btn btn-danger" href="/delete_gradetenant/{{ $gradetenantrow->id }}">
