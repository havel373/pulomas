...
<!-- Mirrored from coderthemes.com/hyper_2/saas/layouts-full.html by HTTrack Website Copier/3.x [XR&CO'2017], Sun, 19 Dec 2021 00:32:06 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body class="loading hide-menu" data-layout="full" data-layout-config='{"leftSideBarTheme":"dark", "layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        <!-- Begin page -->
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
