                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Lead
                                        Prospect/Kontak</h5>
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Growth">Total Pending Informasi
                                        Tagihan</h5>
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Growth">Sewa Yang Akan Berakhir 3
                                        Bulan
                                        Kedepan</h5>
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Growth">Collection Rate Bulan ini
                                    </h5>
                                    <h3 class="mt-3 mb-3">0</h3>
                                    <p class="mb-0 text-muted">
                                    </p>
