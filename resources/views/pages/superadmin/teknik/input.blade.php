                    ...
                    <form class="needs-validation" id="form_submit">
                        ...
                        @if ($data->id)
                            <button class="btn btn-primary" id="tombol_submit"
                                onclick="handle_save('#tombol_submit', '#form_submit', '{{ route('teknik.update', $data->id) }}', 'PATCH', 'Submit');">Submit</button>
                        @else
                            <button class="btn btn-primary" id="tombol_submit"
                                onclick="handle_save('#tombol_submit', '#form_submit', '{{ route('teknik.store') }}', 'POST', 'Submit');">Submit</button>
                        @endif
                    </form>
                </div> <!-- end preview-->
            </div> <!-- end tab-content-->
