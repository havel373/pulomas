                        ...
                        <div class="tab-pane show active" id="tooltips-validation-preview">
                            <form class="needs-validation">
                                <div class="col-md mb-3">
                                    <label class="form-label" for="validationTooltip01">Nominal Dibayarkan<small class="text-danger"><i>*Required</i></small></label>
                                    <div class="input-group" id="input-group1">
                                        <span class="input-group-text">Rp</span>
                                        <input type="text" class="form-control" id="validationTooltip02" value="0" name="nominal">
                                ...
                                <div class="col-md mb-3">
                                    <label class="form-label" for="validationTooltip01">Bukti Pembayaran<small class="text-danger"><i>*Required</i></small></label>
                                ...
                                <div class="col-md mb-3">
                                    <label class="form-label" for="validationTooltip01">Keterangan Pembayaran<small class="text-danger"><i>*Required</i></small></label>
